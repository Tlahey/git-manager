...
|---|---|
| [`useNotificationWatcher.ts:142-312`](../../apps/desktop/src/hooks/useNotificationWatcher.ts#L142-L312) | Detecting *whether* this type fired (diffing `pr` against `previousPRs`) and building the `AppNotification` payload — 7 near-identical `if` blocks, ~15-20 lines each |
