...
| **UI** | [`SummaryAskPanel`](../../apps/desktop/src/components/daily-summaries/SummaryAskPanel.tsx), inside the repo's daily-summaries panel (*AI ▸ Daily summaries*) |
...
beside it: a text box over your own briefings mostly fails, because you remember what you *did*
...
model adds is *reading* them, not finding them.
