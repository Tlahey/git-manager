...
| **UI**          | [`ChangeExplanationPanel`](../../apps/desktop/src/components/diff-viewer/ChangeExplanationPanel.tsx) above the diff editor, via [`useChangeExplanation`](../../apps/desktop/src/hooks/useChangeExplanation.ts) |
...
| [`ChangeExplanationPanel.test.tsx`](../../apps/desktop/src/components/diff-viewer/ChangeExplanationPanel.test.tsx) | collapsed/streaming/done/error states, stale-file reset                                                                                                                                                                                                                                                                                                                         |
