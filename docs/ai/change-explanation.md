...
Every other diff tool can show you what changed. The reason this feature exists is the *second*
...
*"this is an explanation, not a review"* — no praise, no suggested rewrites.
...
| [`DiffViewCenter.test.tsx`](../../apps/desktop/src/components/git-graph/DiffViewCenter.test.tsx) | shown for WIP diffs, absent for commits and other tabs |
