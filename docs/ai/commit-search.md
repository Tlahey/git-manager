...
| **UI**          | [`AiCommitSearchPanel`](../../apps/desktop/src/features/ai-search/components/AiCommitSearchPanel.tsx) — right panel — via [`useAiCommitSearch`](../../apps/desktop/src/features/ai-search/hooks/useAiCommitSearch.ts), opened from [`AiMenu`](../../apps/desktop/src/components/action-toolbar/AiMenu.tsx) or ⇧⌘F                                                                                                                                                                                         |
| **Memory**      | [`aiCommitSearch.store`](../../apps/desktop/src/features/ai-search/stores/aiCommitSearch.store.ts), persisted per repo, answer **and** matches                                                                                                                                                                                                                                                                                                                                                            |
