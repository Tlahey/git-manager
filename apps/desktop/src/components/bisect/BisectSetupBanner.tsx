  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-4 z-overlay flex justify-center">
      <div
        ...
        className="pointer-events-auto flex flex-col items-center gap-1.5 rounded-2xl border border-border bg-card/95 px-3 py-2 shadow-[0_20px_52px_-10px_rgba(0,0,0,0.55)] backdrop-blur-xs"
      >
