...
/** Metadata column of the PR detail view (inside the center content, GitHub-style): submit-a-review,
 * unresolved code suggestions, then labeled sections for reviewers, assignees, labels, participants
 * and the branch (the first three editable via a shared search popover), plus the lifecycle actions
 * (draft / close / reopen). The PR's changed files live in their own always-visible right panel. */
export function PrMetaSidebar({ repoPath, prNumber }: PrMetaSidebarProps) {
  ...
  if (isLoading || !pr) {
    return (
      <div data-testid="pr-meta-sidebar" className="flex h-full items-center justify-center">
  ...
  return (
    <div data-testid="pr-meta-sidebar">
