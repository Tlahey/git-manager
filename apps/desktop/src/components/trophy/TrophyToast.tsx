    ...
    >
      ...
      <div className="flex-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] font-medium px-1 bg-black/40 rounded text-muted-foreground">
      ...
      <button
        ...
        className="text-muted-foreground hover:text-foreground shrink-0 rounded p-0.5 hover:bg-black/10"
      >
