...
describe('ActionToolbar — composition', () => {
  ...
  it('disables undo/redo/pull/push/stash/pop/terminal when there is no active repo', () => {
  ...
  it('wires the undo/pull/push/pop/terminal buttons to their handlers', async () => {
