...
describe('CardMetaSidebar — assignee', () => {
  it('says the card is unassigned when it is', () => {
    renderSidebar()
...
describe('CardMetaSidebar — due date', () => {
  it('states that there is no deadline rather than showing an empty field', () => {
    renderSidebar()
    expect(screen.getByTestId('card-due-none')).toHaveTextContent('No due date')
...
describe('CardMetaSidebar — priority and tags', () => {
  ...
  it('says when the card has no tags', () => {
    renderSidebar()
    expect(screen.getByTestId('card-meta-tags')).toHaveTextContent('No tags')
  })
