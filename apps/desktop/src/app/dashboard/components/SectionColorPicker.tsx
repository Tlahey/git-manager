  ...
  return (
    ...
    >
      <button
        ...
        className={`flex h-6 w-6 items-center justify-center rounded-full border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
      ...
      {SECTION_COLORS.map((color) => (
        <button
          ...
          className={`flex h-6 w-6 items-center justify-center rounded-full ${SECTION_COLOR_SWATCH[color]} ring-offset-1 ring-offset-popover transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
