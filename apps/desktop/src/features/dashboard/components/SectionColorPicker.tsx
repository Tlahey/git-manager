  ...
  return (
    ...
    >
      <button
        ...
        className={`flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-hidden ${
      ...
      {SECTION_COLORS.map((color) => (
        <button
          ...
          className={`flex h-6 w-6 cursor-pointer items-center justify-center rounded-full ${SECTION_COLOR_SWATCH[color]} ring-offset-1 ring-offset-popover transition-shadow focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-hidden ${
