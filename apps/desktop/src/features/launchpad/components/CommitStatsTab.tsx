                    ...
                    <div key={i} className="group/bar flex flex-1 flex-col items-center gap-1">
                      ...
                      >
                        {day.commits > 0 ? (
                          ...
                          >
                            <div className="absolute -top-5 left-1/2 hidden -translate-x-1/2 rounded border border-border bg-popover px-1 py-px text-[9px] whitespace-nowrap text-foreground shadow-xs group-hover/bar:block">
                              {day.commits}
                            </div>
                          </div>
                        ) : (
