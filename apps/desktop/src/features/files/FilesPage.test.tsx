...
vi.mock('../../components/terminal/TerminalPanel', () => ({ TerminalPanel: () => <div /> }))
vi.mock('../../components/terminal/TerminalStatusBar', () => ({ TerminalStatusBar: () => <div /> }))
...
describe('FilesPage — directory listing', () => {
...
describe('FilesPage — opening a file', () => {
