...
vi.mock('./components/ConflictResolutionPanel', () => ({
...
vi.mock('../../components/rebase-progress/RebaseProgressCenter', () => ({
...
vi.mock('./components/CommitSearchPanel', () => ({
