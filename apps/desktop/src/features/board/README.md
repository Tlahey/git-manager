...
| `components/` | Every view, from the card face to the eleven dialogs. Presentational; they receive handlers.       |
...
| `lib/`        | Pure logic, no React: identifier derivation, badge ink, link inverse-resolution, move targets, sprint statistics, checklist parsing, attachment markdown. |
