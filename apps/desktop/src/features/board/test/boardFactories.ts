...
export function makeBoardData(overrides: Partial<BoardData> = {}): BoardData {
  return {
    ...
    assignCardIdentifiers: vi.fn().mockResolvedValue(0),
    ...
    deleteArchivedCards: vi.fn().mockResolvedValue(0),
    archiveColumn: vi.fn().mockResolvedValue(0),
    moveColumnCards: vi.fn().mockResolvedValue(0),
