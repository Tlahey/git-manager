...
vi.mock('../github/github-issues.api', async () => {
  const actual =
    await vi.importActual<typeof import('../github/github-issues.api')>('../github/github-issues.api')
  return {
    ...actual,
...
vi.mock('../github/github-labels.api', async () => {
  const actual =
    await vi.importActual<typeof import('../github/github-labels.api')>('../github/github-labels.api')
  return { ...actual, addLabels: vi.fn(), removeLabel: vi.fn() }
})

import * as tauri from '../../lib/tauri'
import * as issuesApi from '../github/github-issues.api'
import * as labelsApi from '../github/github-labels.api'
