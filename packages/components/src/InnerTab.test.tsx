...
describe('InnerTab', () => {
  it('renders children and calls onClick', async () => {
    ...
    render(
      <InnerTab active={false} onClick={onClick}>
        Open
      </InnerTab>
    )
  ...
  it('shows the count badge when given', () => {
    render(
      <InnerTab active={false} onClick={vi.fn()} count={5}>
        Open
      </InnerTab>
    )
  ...
  it('hides the count badge when not given', () => {
    render(
      <InnerTab active={false} onClick={vi.fn()}>
        Open
      </InnerTab>
    )
  ...
  it('shows a loading skeleton instead of the count while loading', () => {
    render(
      <InnerTab active={false} onClick={vi.fn()} count={5} loading>
        Open
      </InnerTab>
    )
